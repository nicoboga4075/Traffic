...
# Le feu tricolore est maintenu par défaut au rouge.

# En cas d’approche d’un usager, le feu reste au rouge si l’automobiliste dépasse la vitesse autorisée, et le feu passe au vert si le véhicule est détecté en dessous de la vitesse limite autorisée.
